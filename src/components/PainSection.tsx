const PAINS = [
  ...
  },
  {
    ...
    body: "Disputed claims, regulatory audits, malpractice — all rely on what's in the record. Salvia's immutable, timestamped trail means every word is traceable back to the original audio.",
    stat: '100%',
