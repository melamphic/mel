const PAINS = [
  {
    ...
    body: 'Clinicians spend 1–3 hours after every shift finishing documentation. With Salvia, you record a short voice note, pick your forms, and the draft is already filled in before you sit down to review.',
    stat: '2.1 hrs',
  ...
  },
  {
    ...
    body: 'HIPAA, NABH, VMR, ADA, aged-care standards — your team can\'t memorise every clause. Salvia links your rulebook directly to each form field and flags gaps before a note is ever signed.',
    stat: '68%',
  ...
  },
  {
    ...
    body: "Disputed claims, regulatory audits, malpractice — all of it rests on what's in the record. Salvia keeps a hashed, timestamped trail: every field traceable back to the original audio.",
    stat: '100%',
