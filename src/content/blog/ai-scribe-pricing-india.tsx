export const content = (
  <>
    ...
    <h3>The three pricing models you'll run into</h3>
    <p>
      Almost every tool sold to Indian clinics falls into one of three shapes, and the shape matters
      more than the sticker price:
    </p>
    <ul>
      <li>
        <strong>Free / trial tier.</strong> Usually a daily cap — something like five consults a day.
        Fine for a single doctor testing whether dictation fits their OPD rhythm. Not built for a
      ...
      <li>
        ...
        with a monthly pool of AI notes plus the compliance machinery — drug register, incident log,
        consent capture, statutory forms and audit-ready export. Priced for the clinic, not the seat.
      </li>
    </ul>

    <h3>Why some tools price per doctor and others per clinic</h3>
    <p>
      A pure scribe only has to do one job — turn speech into a note — so it scales by the person
      speaking. A compliance suite has to hold the <em>whole clinic's</em> regulated record: the
      Schedule H1 register, the consent witness, the incident trail, the report templates an NABH or
      CEA assessor asks for. That work isn't per-doctor; it's per-practice. So the pricing follows the
      product. A three-doctor clinic pays three times for a per-seat scribe, but once for a per-clinic
      suite.
    </p>

    <h3>What Salvia costs in India</h3>
    <p>
      Salvia is a per-clinic compliance suite, billed in rupees, with unlimited staff on every plan.
    ...
    <p>
      A scribe's price buys you a clean note. It does not, on its own, make you NABH or ABDM ready.
      The drug register still has to reconcile. Consent still has to be witnessed and stored. Incidents
      still have to be logged in a form an assessor recognises. If your scribe doesn't do that, you are
      buying a second system — a hospital-management or quality module — to cover it, and that is the
    ...
    <h3>The real math for a three-doctor clinic</h3>
    <p>
    ...
    <ul>
      <li><strong>Solo doctor, notes only, no accreditation pressure:</strong> a per-doctor scribe (or
        even a free tier) is the right, cheapest answer.</li>
      <li><strong>Multi-clinician clinic, or anyone chasing NABH / ABDM / PM-JAY:</strong> a per-clinic
        compliance suite costs more on the sticker and less in total, because the audit work is already
        inside it.</li>
    </ul>
    ...
    <p><strong>Why is some pricing per doctor and some per clinic?</strong><br />
      A scribe scales with the person dictating, so it's priced per seat. A compliance suite holds the
      whole clinic's regulated record, so it's priced per practice with unlimited staff.</p>
    <p><strong>Does an AI scribe make my clinic NABH or ABDM compliant?</strong><br />
      Not by itself. A scribe produces a note. NABH and ABDM readiness need a reconciled drug register,
      witnessed consent, an incident trail and audit-ready export — which is what a compliance suite
